...
public class ProfileTest extends BasicTest {
	...
	public void editProfileTest() throws InterruptedException {
		...
		Assert.assertTrue(notificationSystemPage.getAlertTxt().contains(msgSuccLogin),
		...
		Assert.assertTrue(notificationSystemPage.getAlertTxt().contains(msgSuccSetup),
				" [ERROR] Unexpected setup message ");
		notificationSystemPage.noAlertMsgWait();

		authPage.logoutUser();

		Assert.assertTrue(notificationSystemPage.getAlertTxt().contains(msgSuccLogout),
	...
	public void changeProfileImage() throws IOException, InterruptedException, AWTException {
		...
		Assert.assertTrue(notificationSystemPage.getAlertTxt().contains(msgSuccImgUpload),
		...
		Assert.assertTrue(notificationSystemPage.getAlertTxt().contains(msgSuccImgDelete),
